...
(function () {
  ...
  const DEFAULT_DATA = {
    hero: {
      tag: "Inovação em Neurocirurgia",
      title: "Precisão<br />que <em>salva</em><br /><strong>vidas</strong>",
      text: "Desenvolvemos soluções cirúrgicas de alta performance reconhecidas em mais de 40 países. Tecnologia brasileira com padrão internacional.",
      primaryButton: "Conheça os produtos",
      secondaryButton: "Nossa história"
    },
    about: {
      tag: "Sobre a Kiyan",
    ...
    productsIntro: {
      tag: "Produtos",
      title: "Linha de produtos <strong>Kiyan</strong>",
      text: "Conheça soluções desenvolvidas para precisão, controle e segurança."
    },
    contact: {
      tag: "Fale conosco",
